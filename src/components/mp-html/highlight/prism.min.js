/* PrismJS 1.30.0
https://prismjs.com/download.html#themes=prism-solarizedlight&languages=markup+css+clike+javascript+bash+java+json+less+nginx+python+jsx+tsx+scss+sql+typescript+yaml&plugins=line-numbers+show-language+toolbar */
